...
const services = [
  ...
  "FSSAI License", "Startup India Registration", "MSME Registration", 
  "Import Export Code", "Patent Registration", "Copyright Registration", 
  "Partnership Firm Registration", "Shop and Establishment License", 
  "Professional Tax Registration", "Digital Signature Certificate", 
  "Section 8 Company", "Nidhi Company", "Producer Company", "Trust Registration"
];
...
const categories = ["Legal", "Tax", "Compliance", "Services", "IP", "Finance", "Startup", "General"];

const adjectives = ["Fast", "Affordable", "Online", "Best", "Trusted", "Professional", "Expert", "Quick"];
        ...
        const content_blocks = [
            ...
            },
            {
                ...
                "content": {
                    ...
                    "left_content": "<h3>Local Expertise</h3><p>We understand the local regulations and requirements in " + location + ".</p>",
                    "right_content": "<h3>Online Process</h3><p>Complete the entire process from the comfort of your home or office.</p>"
                }
            },
            {
                "type": "faq",
                ...
                "content": {
                    ...
                    "questions": [
                        {"question": `Is physical presence required in ${location}?`, "answer": "No, our process is completely online."},
                        {"question": "How long does it take?", "answer": "Typically 3-5 working days depending on government processing times."}
                    ]
                }
            },
            {
