      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden bg-slate-900 border-b border-slate-800">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-white leading-[1.1] drop-shadow-sm">
            Simplify Your <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 via-blue-400 to-indigo-300">
              Legal Journey
            </span>
          </h1>

          <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed font-light">
            Access over <span className="text-white font-medium">1000+</span> expert-verified
            guides, registration services, and compliance checklists. Fast, affordable, and 100%
            online.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-sm font-medium text-slate-400">
            ...
            {['Private Limited', 'GST Registration', 'Trademark', 'FSSAI License'].map((term) => (
              <a
                href={`/${term.toLowerCase().replace(/ /g, '-')}`}
                key={term}
                className="hover:text-blue-300 transition-colors border-b border-transparent hover:border-blue-300/50 pb-0.5"
              >
                {term}
              </a>
            ))}
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-2xl space-y-4">
            ...
            <p className="text-gray-500 dark:text-slate-400 text-lg leading-relaxed">
              Everything you need to start, manage, and grow your business in India. Categorized for
              easy access.
            </p>
          </div>
          <a
            href="/services"
            className="group px-6 py-3 bg-white dark:bg-slate-900 text-gray-900 dark:text-white font-semibold rounded-xl border border-gray-200 dark:border-slate-800 hover:border-blue-500 dark:hover:border-blue-500 transition-all flex items-center shadow-sm hover:shadow-md"
          >
            View All Categories{' '}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg">
              Get your business compliant in 3 simple steps
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Choose from 1000+ legal and compliance services tailored for you.',
              },
              {
                title: 'Submit Details',
                desc: 'Upload documents securely to our encrypted online portal.',
              },
              {
                title: 'Get Delivered',
                desc: 'Receive your registration or license digitally in record time.',
              },
            ].map((step, i) => (
              <div
                key={i}
                className="relative p-10 rounded-3xl bg-gray-50 dark:bg-slate-800/50 border border-transparent hover:border-blue-100 dark:hover:border-slate-700 transition-colors group"
              >
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Most requested services by businesses this week
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-12 md:p-20 text-center text-white shadow-2xl shadow-blue-900/20 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Talk to our experts today and get a free consultation on the best legal structure for
              your startup.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
              ...
              <button className="px-8 py-4 bg-blue-700/50 text-white border border-blue-400/30 rounded-xl font-bold hover:bg-blue-700 transition-colors backdrop-blur-sm">
                View all Services
              </button>
            </div>
          </div>
